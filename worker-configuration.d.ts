/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d464bfef2264e54e0367b32c5e424965)
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        'LOCALSTACK_ENDPOINT' | 'AWS_ACCESS_KEY_ID' | 'AWS_SECRET_ACCESS_KEY' | 'AWS_REGION' | 'SKIP_SSL_CERT_DOWNLOAD'
      >
    > {}
}
